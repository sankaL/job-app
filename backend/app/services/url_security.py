...
class OutboundResolutionUnavailable(RuntimeError):
    """A public-host safety check could not complete due to a transient resolver failure."""
...
async def validate_public_http_url(
    ...
    *,
    ...
    try:
        ...
        raise OutboundResolutionUnavailable(
            "Job URL resolution is temporarily unavailable."
        ) from error
